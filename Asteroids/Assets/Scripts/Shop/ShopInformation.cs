...
public class ShopInformation : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        string testString =
            "First ship to get money\r\nIncrements 5% ship velocity (max speed is not included)\r\nIncrements 10% ship velocity and 5% rotation speed (max speed is not included)\r\nIncrements 15% ship velocity and 15% rotation speed (max speed is not included)\r\nThe big asteroid (the one who generates 2 tiny asteroids) gives $2\r\nThe big asteroid gives $3\r\nThe big asteroid gives $4\r\nThe big asteroid gives $5\r\nThe big asteroid gives $6\r\nThe big asteroid gives $7\r\nThe big asteroid gives $8\r\nThe big asteroid gives $9\r\nBullet skin\r\nGet a new life, but the next one increments x2\r\nShoot an extra bullet, but the next one increments x2 (max = 3)\r\n0\r\n40\r\n60\r\n80\r\n0\r\n30\r\n50\r\n70\r\n90\r\n110\r\n130\r\n150\r\n0\r\n10\r\n10\r\n10\r\n20\r\n20\r\n20\r\n20\r\n30\r\n30\r\n30\r\n30\r\n40\r\n40\r\n40\r\n40\r\n40\r\n45";

        fileInformation = testString.Split(new string[] { "\r\n" }, System.StringSplitOptions.None);
    ...
    public void Init()
    {
        ...
        //extra life
        int.TryParse(fileInformation[43], out prices[3][0]);
        acquired[3][0] = false;
        //selectedObject = 1 to show the buy button only
        selectedObject[3] = 1;

        //extra bullet
        int.TryParse(fileInformation[44], out prices[4][0]);
        acquired[4][0] = false;
        selectedObject[4] = 1;
